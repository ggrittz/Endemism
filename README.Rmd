...
- [`R/`](https://github.com/ggrittz/Endemism/tree/master/R):
...
Launch the [`make.R`](https://github.com/ggrittz/Endemism/tree/master/make.R)
file with:
...
check out our [Contributor Guidelines](https://github.com/ggrittz/Endemism/blob/main/CONTRIBUTING.md).
